...
<input type="hidden" name="cifseqno" id="cifseqno"/>
        ...
        <div id="content">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td>
                    	<input type="text" id="custName" style="width:250px;cursor:pointer" readonly/>
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" id="accntStatus" style="width:200px" value="FOR VERIFICATION" readonly/></td>
                </tr>
            </table>
        </div>
    </div>
