...
<div style="width:550px">
	<h1>Update Customer Approval</h1>
...
$(function() {
	...
	$(verifyBtn).click(function (e) {
		messageBox('Approve selected customers?', 'Confirm', 'confirm', function () {
			...
			requests.push(
				jqxhr = $.ajax({
					type: 'POST',
					url: 'customer/editapproval/verify',
					dataType: 'json',
					data: form.serialize(),
					beforeSend: function() {
	...
	$(rejectBtn).click(function (e) {
		messageBox('Reject selected customer edit?', 'Confirm', 'confirm', function () {
			//serialize AJAX request
			requests.push(
				jqxhr = $.ajax({
					type: 'POST',
					url: 'customer/editapproval/reject',
					dataType: 'json',
					data: form.serialize(),
					beforeSend: function() {
	...
	function getData() {
		...
		requests.push(
			jqxhr = $.ajax({
				type: 'GET',
				url: 'customer/editapproval/getdata',
				dataType: 'json',
				data: {
...
function searchRedirect(custkey) {
    $.ajax({
        type: 'POST',
        url: 'customer/editapproval/cache',
        data: {
            'cifseqno': custkey,
            'custappr': true
        },
