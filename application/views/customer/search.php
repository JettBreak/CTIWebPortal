        ...
        <div id="content">
            <table width="100%">
                ...
                <tr>
                    ...
                    <td><input type="text" name="custLastName" id="custLastName" style="width:250px" maxlength="30" class="validate[custom[onlyLetterSpCustom]] alphaNumCustom"/></td>
				</tr>
                <tr>
                    <td><label for="custFirstName">First Name:</label></td>
                    <td><input type="text" name="custFirstName" id="custFirstName" style="width:250px" maxlength="30" class="validate[custom[onlyLetterSpCustom]] alphaNumCustom"/></td>
				</tr>
                <tr>
                    <td><label for="custMiddleName">Middle Name:</label></td>
                    <td><input type="text" name="custMiddleName" id="custMiddleName" style="width:250px" maxlength="30" class="validate[custom[onlyLetterSpCustom]] alphaNumCustom"/></td>
                </tr>
            </table>
        </div>
    </div>
