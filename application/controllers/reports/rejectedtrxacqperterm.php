...
class RejectedTrxAcqPerTerm extends CI_Controller {	

	function __construct()
	{
		parent::__construct();
		$this->load->library('core');
		$this->core->checkUserAllows(REJECTEDTRXACQPERTERM_NO);
	}
	...
	function preview()
	{
		...
		$result = $reports->getRejectedSumAcquirerPerTerminal($reportLog, $branchCode, $finswitch, $dtFrom, $dtTo);
		//
		...
		$pdf->SetTitle('Rejected Transactions');
		$pdf->SetSubject('Card');
		...
		<h2>'.$instName.'</h2>
		<h1>REJECTED TRANSACTIONS, ACQUIRER PER TERMINAL SUMMARY</h1>
		<h3>'. $branchName .'</h3>
		<h4>'. $reportDate .'</h4>
		...
		$pdf->Output('rejectedtrxacqperter_' . $dateSaveFormat . '.pdf', 'I');
	}
}
/* End of file rejectedtrxacqperter.php */
/* Location: ./application/reports/rejectedtrxacqperter.php */