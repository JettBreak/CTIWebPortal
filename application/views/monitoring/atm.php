        ...
        <div id="tabInfo" class="tab_content">
            <table>
                ...
                <tr>
                    ...
                    <td colspan="3" id="infoTerminalLoc"><?php echo $infoTerminalLoc ?></td>
                </tr>
                <tr>
                    <td class="label">Area:</td>
                    <td colspan="3" id="infoTerminalArea"><?php echo $infoAreaName ?></td>
                </tr>
                <tr>
                	<td class="label">Branch:</td>
                    <td colspan="3" id="infoTerminalBranch"><?php echo $infoBranchName ?></td>
                </tr>
                <tr>
