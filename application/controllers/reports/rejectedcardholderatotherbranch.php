...
class RejectedCardHolderAtOtherBranch extends CI_Controller {	
	...
	function preview()																																																																																																																																																																																																			
	{
		...
		$result = $reports->getRejectedOurRChatOtherBranch($reportLog, $branchCode, $termType, $onusCode, $dtFrom, $dtTo);
		...
		$pdf->SetTitle('Rejected Our Cardholder at Other Branch');
		$pdf->SetSubject(NULL);
		...
		foreach ($data as $key => $d) {
			...
			<h2>'.$instName.'</h2>
			<h1>REJECTED OUR CARDHOLDER AT OTHER BRANCH: '. $key .'</h1>
			<h3>'. $branchName .'</h3>
			...
			<thead>
				<tr>
					...
					<th width="180" align="center">TRX AMT</th>
					<th width="180" align="center">AMT AUTH</th>
				</tr>
			</thead>
			<tbody>
				'. $d['content'] .'
		...
		$pdf->Output('rejectedcardholderatotherbranch_' .$dateSaveFormat . '.pdf', 'I');
	}
}
/* End of file rejectedcardholderatotherbranch.php */
/* Location: ./application/reports/rejectedcardholderatotherbranch.php */