<form id="custISOForm" method="post"  action="customer/requestCustomer/upload" enctype="multipart/form-data" target="uploadTarget">
    <input type="hidden" name="custCifseqno" value="<?php echo $cifseqno; ?>"/>
    <input type="hidden" name="custBlobPic" value="<?php echo $blobPic; ?>"/>
    <div id="custEdit">
        <h1>Edit Customer Entry <span class="floatRight">CIF Number: <?php echo $cifseqno; ?></span></h1>
        <div id="content"><span class="floatRight hint">Enter customer details then press submit to send<br /><span class="floatRight"><span class="red">*</span> - Required Fields</span></span></span>
            ...
            <table width="80%" style="margin-top:10px">
                ...
                <tr>
                    ...
                    <td><input type="text" name="custLastName" id="custLastName" style="width:110px" maxlength="50" value="<?php echo $lastName; ?>" class="validate[required,custom[onlyLetterSpCustom]] alphaNumCustom"/></td>
                    <td><input type="text" name="custFirstName" id="custFirstName" style="width:110px" maxlength="50" value="<?php echo $firstName; ?>" class="validate[required,custom[onlyLetterSpCustom]] alphaNumCustom"/></td>
                    <td><input type="text" name="custMiddleName" id="custMiddleName" style="width:110px" maxlength="30" value="<?php echo $middleName; ?>" class="validate[custom[onlyLetterSpCustom]] alphaNumCustom"/></td>
            ...
            <div class="divider customer-address-contact">
                <table class="customer-address-table">
                    ...
                    <tr>
                        <td><label for="custStreet1">Street 1: <span class="red"><?php echo $addr1reqSign; ?></span></label></td>
                        <td colspan="3"><input type="text" name="custStreet1" id="custStreet1" style="width:220px" maxlength="50" value="<?php echo $address1; ?>" class="<?php echo $addr1isReq; ?>"/></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td><label for="custCity">Town / City: <span class="red"><?php echo $cityreqSign; ?></span></label></td>
                        <td width="110"><input type="text" name="custCity" id="custCity" style="width:80px" maxlength="30" value="<?php echo $city; ?>" class="<?php echo $cityisReq; ?>"/></td>
                        <td width="70"><label for="custZipCode">ZIP Code: <span class="red"><?php echo $zipCreqSign; ?></span></label></td>
                        <td><input type="text" name="custZipCode" id="custZipCode" style="width:32px" maxlength="4" value="<?php echo $zipCode; ?>" class="<?php echo $zipCisReq; ?>"/></td>
                    </tr>
                    <tr>
                        <td><label for="custProvince">Province: <span class="red"><?php echo $prvnreqSign; ?></span></label></td>
                        <td colspan="3"><input type="text" name="custProvince" id="custProvince" style="width:220px" maxlength="30" value="<?php echo $province; ?>" class="<?php echo $prvnisReq; ?>"/></td>
                    </tr>
                </table>
    ...
    <div id="bottom"><span class="buttons floatLeft">
        <button id="submitBtn" value="customer/requestCustomer/submit">Submit</button>
...
<script>
$(function () {
    //filterPrefixes($('input[name="custGender"]').val(), '<?php echo $prefix; ?>');
    ...
    //$('input[name="custGender"]').trigger('change');
    ...
    $($custImg).change(function () {
        $form.attr('action', 'customer/requestCustomer/upload');
...
function uploadDone() {
	...
	if (data) {
		...
		if (data.success === true) {
			...
			messageBox('Customer is now for approval');
			$(MSGBOX).one('dialogbeforeclose', function () {
				window.location.hash = 'customer/search2'
			});
