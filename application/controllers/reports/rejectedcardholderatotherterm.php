...
class RejectedCardHolderAtOtherTerm extends CI_Controller {	
	...
	function preview()
	{
		...
		$pdf->SetTitle('Rejected Our Cardholder at Our Bank Terminal');
		$pdf->SetSubject(NULL);
		...
		foreach ($data as $key => $d) {
			...
			<h2>'.$instName.'</h2>
			<h1>REJECTED OUR CARDHOLDER AT OTHER TERMINAL: '. $key .'</h1>
			<h3>'. $branchName .'</h3>
