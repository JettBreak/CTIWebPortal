...
class IssIBFTTrx extends CI_Controller {	
	...
	function preview()
	{
		...
		$result = $reports->getIBFTIssuerTransaction($reportLog, $branchCode, $termType, $finswitch, intval(BANK_CODE), $dtFrom, $dtTo);
		...
		foreach ($tpt as $row) {
			...
			$content = '<tr>
				...
				<td'. $a1Align .'>'. substr($acct1, -14) .'</td>
				<td>'. $acctDesc .'</td>
				<td>'. $row['msgtype'] .'</td>	
				<td>'. $mnemonic .'</td>	
				<td>'. $xml->getVALUE('ACQCODE_MNEM') .'</td>	
				<td'. $a2Align .'>'. substr($acct2, -14) .'</td>	
				<td align="right">'. $row['sysvcode'] .'</td>	
		...
		foreach ($data as $key => $d) {
			...
			<table cellspacing="10" width="100%">
				<tr>
					...
					<th width="120">LUNO</th>
					<th width="250">BANK ID / CARD #</th>
					<th width="120" align="center">ISSUER</th>
					<th width="270">FROM <br>ACCOUNT</th>
					<th width="60">TY</th>
					<th width="60">TC</th>
					<th width="150">TRXCODE</th>
					<th width="120">BANK</th>
					<th width="270">TO <br>ACCOUNT</th>
					<th width="80">VCD</th>
					<th width="280" align="center">REMARKS</th>
