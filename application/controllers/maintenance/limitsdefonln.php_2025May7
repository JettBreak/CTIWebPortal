...
class LimitsDefOnln extends CI_Controller { 
  ...
  function __construct()
  {
    ...
    $this->core->checkUserAllows(LIMITSDEFONLN_NO);
  ...
  function index()
  {
    ...
    $auditXML .= '<old></><new></><field>Default Online Limits</><details>Open Module</>';
  ...
  function submit()
  {
    ...
    $cyclemax = $cyclemax == 'N/A' ? 0 : $cyclemax;
    $cycledef = $cycledef == 'N/A' ? 0 : $cycledef;

    $tranmax = $tranmax == 'N/A' ? 0 : $tranmax;
    $tranmaxdef = $tranmaxdef == 'N/A' ? 0 : $tranmaxdef;
    $tranmin = $tranmin == 'N/A' ? 0 : $tranmin;
    $tranmindef = $tranmindef == 'N/A' ? 0 : $tranmindef;

    $nonfeetran  = $nonfeetran == 'N/A' ? 0 : $nonfeetran;
    $nonfeetrandef = $nonfeetrandef == 'N/A' ? 0 : $nonfeetrandef;
