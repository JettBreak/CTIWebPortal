    ...
    <div class="bottom">
        <div class="dataTables_custom floatLeft" style="margin: 5px 0 0 50px">
            ...
            <span class="info">
                ...
                <label for="autoRefresh">Refresh every </label><input type="number" id="secs" style="width:30px" class="numbersOnly" step="1" min="10" max="99" value="60" disabled><label for="autoRefresh"> secs.</label>
            </span>
            <span id="loadingMsg" class="info">
            	Retrieving data...
            </span>
		</div>
    </div>
...
$(function () {
    ...
    oTable = $(DATATABLE).dataTable({
        ...
        iDisplayLength: 25,
		aLengthMenu: [
			[25, 50, 100, 200, 500, 1000, 10000], [25, 50, 100, 200, 500, 1000, 10000] // -1 = 'All'
		],
        aaSorting: [],
		aoColumns: [
			null, //time
		...
		fnRowCallback: function(nRow, aData, iDisplayIndex) {
			...
			var tooltip = 'Host Name: ' + aData[15] + '\n' +
				'Void Code: ' + aData[9];
