...
define('HOST_MONITORING',	'6');
define('IBFTPTR',			8882);
define('TRXCODE_CVV1',		704001);
define('TRXCODE_ICVV',		704111);
...
define('CUSTREQUEST_NO', 94);
define('CUSTAPPROVAL_NO', 95);
define('CUSTDELETE_NO', 97);
define('CUSTEDITAPPROVAL_NO', 99);
define('CUSTBATCHUPLOAD_NO', 106);
//Account management
...
define('ACCNTUPLOAD_NO', 104);
define('ACCNTCHNGESTAT_NO', 93);
define('ACCOUNTGET_NO', 110);
//Card management
...
define('GENDEFPIN', 87);
define('RESETPIN', 88);
define('CARDISSUANCEAPPROVAL_NO', 100);
define('CARDUPDATE_NO', 101);
define('ACCTUPDATE_NO', 102);
define('REPORTPROCLIST_NO', 103);
define('CARDBATCHUPLOAD_NO', 105);
...
define('MONHOST_NO', 111);
//define('MONCARD_NO', 111);
//Reports
...
define('POSTRX_NO', 78);
define('POSLOANPAY_NO', 89);
define('POSLOANPAYACQ_NO', 90);
define('AUTOLOADTRX_NO', 79);
define('BILLSPAYMENTREP_NO', 43);
define('PINMAILERBATCHREP_NO', 86);
define('APPROVEDMOBILEBNKNGREP_NO', 91);
define('REJECTEDMOBILEBNKNGREP_NO', 92);
define('INPUTFILESREP_NO', 107);
//Maintenance
...
define('PRODUCTNEW_NO', 96);
define('CARDPRODUCTLIST_NO', 98);
define('POSINST_NO', 108);
define('POSOUTLET_NO', 109);
define('MOBILE_NO', 112);
define('PRRULES_NO', 113);
define('CARDHOLDER_NO', 118);
//PIN Mailer
define('PINMAILER_NO', 114);
define('PROCESSPINMAILER_NO', 115);
define('REPRINTPINMAILER_NO', 116);
define('LAYOUTSETTINGS_NO', 117);

define('PINVKEY_NO',118);

define('PERSO_FILE_SFTP_ADDR', '120.28.150.235');
define('PERSO_FILE_SFTP_PORT', '22');
define('PERSO_FILE_SFTP_USER', 'usb');
